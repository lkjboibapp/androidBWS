package com.example.kuhas.myapplication.view;
...
public class ListItem extends BaseCustomViewGroup {
    ...
    private void initInflate() {
        inflate(getContext(), R.layout.name_list, this);
    }

    private void initInstances() {

        tvname = findViewById(R.id.tx);
        // findViewById here
    }
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        int newHeight = MeasureSpec.makeMeasureSpec(
                height,
                MeasureSpec.EXACTLY
        );
